...
public class OrderDAO extends JDBConnect {
	...
	public int findCount(Map<String, Object> map) {
		...
		String query = "selectmenu_id, con_name, con_price from condiment";
		if(map.get("bread") == bread) {
			query += " where con_kind like '%" + map.get("bread") +"%'";
		}else if(map.get("topping") == topping) {
			query += " where con_kind like '%" + map.get("topping") +"%'";
		}else if(map.get("side") == side) {
			query += " where con_kind like '%" + map.get("side") +"%'";
		}else if(map.get("beverage") == beverage) {
			query += " where con_kind like '%" + map.get("beverage") +"%'";
		}
	...
	public List<CondimentDTO> selectFindCountCount(Map<String, Object> map) {
		...
		String query = "select menu_id, con_name, con_price from condiment"; // sql condiment테이블 조회
		if(map.get("bread") == bread) {
			query += " where con_kind like '%" + map.get("bread") +"%'";
		}else if(map.get("topping") == topping) {
			query += " where con_kind like '%" + map.get("topping") +"%'";
