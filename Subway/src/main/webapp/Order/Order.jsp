...
if(bread != null && topping != null && side != null && beverage != null) {
	param2.put("bread", bread);
	param2.put("topping", topping);
	param2.put("side", side);
	param2.put("beverage", beverage);
}
int totalCount2 = dao2.selectCount(param2); // 게시물 수 확인(위에서 만든 파라미터 값을 매개값으로 전달)
List<CondimentDTO> condimentLists2 = dao2.selectList(param2); // 게시물 목록 받기
...
<jsp:include page="../Main/MenuListBootStrap.jsp" />
	...
	<div class="menu_title">
		...
		<form method="get">
			<ul>
				<li><input id="bread" type="submit" name="bread" value="bread"></li>
				<li><input id="topping" type="submit" name="topping"
					value="topping"></li>
				<li><input id="side" type="submit" name="side" value="side"></li>
				<li><input id="beverage" type="submit" name="beverage"
					value="beverage"></li>
			</ul>
		</form>
	</div>
